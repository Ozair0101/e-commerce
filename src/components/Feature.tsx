    ...
    return (
        <main className="flex-grow">
            ...
            <section className="py-12 md:py-20 relative overflow-hidden">
                ...
                <div className="absolute top-0 left-0 w-full h-full bg-gradient-to-b from-white to-background-light -z-10"></div>
                <div className="absolute -top-[20%] -right-[10%] w-[50%] h-[50%] bg-primary/10 rounded-full blur-[100px] pointer-events-none"></div>
                <div className="max-w-[1280px] mx-auto px-4 md:px-8">
                    {/* Header & Timer */}
                    <div className="flex flex-col md:flex-row items-center justify-between gap-8 mb-12">
                        <div className="text-center md:text-left">
                            <span className="inline-block px-3 py-1 rounded-full bg-primary/20 text-green-800 text-xs font-bold uppercase tracking-wider mb-2">Limited Time Offer</span>
                            <h1 className="text-3xl md:text-5xl font-bold leading-tight mb-2">Weekly <span className="text-transparent bg-clip-text bg-gradient-to-r from-primary to-green-600">Glow-Up</span> Deals</h1>
                            <p className="text-slate-500 max-w-md">Light up your savings with our hottest candle selections. Grab them before they melt away!</p>
                        </div>
                        {/* Countdown Timer */}
                        <div className="flex items-center gap-3 bg-white p-4 rounded-xl shadow-lg shadow-gray-200/50 border border-gray-100">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                        {/* Card 1: Bestseller */}
                        <div className="group bg-white rounded-[2rem] p-3 shadow-sm hover:shadow-xl hover:shadow-primary/10 transition-all duration-300 hover:-translate-y-1 border border-transparent hover:border-primary/20">
                            <div className="relative aspect-square w-full rounded-[1.5rem] overflow-hidden mb-4 bg-gray-100">
                                {/* Badge */}
                                <div className="absolute top-3 left-3 bg-white/90 backdrop-blur text-slate-900 text-xs font-bold px-3 py-1.5 rounded-full z-10 shadow-sm">
                                    Bestseller
                                </div>
                                ...
                                <div className="absolute bottom-4 left-1/2 -translate-x-1/2 translate-y-20 group-hover:translate-y-0 transition-transform duration-300 flex gap-2">
                                    <button className="size-10 bg-white rounded-full shadow-lg flex items-center justify-center hover:bg-primary hover:text-slate-900 transition-colors">
                            ...
                            <div className="px-2 pb-2">
                                <h3 className="text-lg font-bold text-slate-900 mb-1 group-hover:text-primary transition-colors">Lavender Driftwood</h3>
                                ...
                                <button className="w-full h-12 rounded-xl bg-slate-900 text-white font-bold hover:bg-primary hover:text-slate-900 transition-all flex items-center justify-center gap-2 group/btn">
                        ...
                        <div className="group bg-white rounded-[2rem] p-3 shadow-sm hover:shadow-xl hover:shadow-primary/10 transition-all duration-300 hover:-translate-y-1 border border-transparent hover:border-primary/20">
                            <div className="relative aspect-square w-full rounded-[1.5rem] overflow-hidden mb-4 bg-gray-100">
                                <div className="absolute top-3 left-3 bg-primary text-slate-900 text-xs font-bold px-3 py-1.5 rounded-full z-10 shadow-sm">
                                    Bundle Deal
                                </div>
                                <div className="absolute top-3 right-3 bg-red-500 text-white text-xs font-bold px-2 py-2 rounded-full z-10 shadow-sm w-12 h-12 flex items-center justify-center">
                                    -25%
                            ...
                            <div className="px-2 pb-2">
                                <h3 className="text-lg font-bold text-slate-900 mb-1 group-hover:text-primary transition-colors">Citrus Summer Trio</h3>
                                <div className="flex items-center gap-1 mb-3">
                                    <span className="material-symbols-outlined text-yellow-400 text-[16px]">star</span>
                                    <span className="material-symbols-outlined text-yellow-400 text-[16px]">star</span>
                                    <span className="material-symbols-outlined text-yellow-400 text-[16px]">star</span>
                        ...
                        <div className="group bg-white rounded-[2rem] p-3 shadow-sm hover:shadow-xl hover:shadow-primary/10 transition-all duration-300 hover:-translate-y-1 border border-transparent hover:border-primary/20">
                            <div className="relative aspect-square w-full rounded-[1.5rem] overflow-hidden mb-4 bg-gray-100">
                                <div className="absolute top-3 left-3 bg-gray-900 text-white text-xs font-bold px-3 py-1.5 rounded-full z-10 shadow-sm">
                                    Clearance
                                </div>
                                <div className="absolute top-3 right-3 bg-red-500 text-white text-xs font-bold px-2 py-2 rounded-full z-10 shadow-sm w-12 h-12 flex items-center justify-center">
                                    -40%
                            ...
                            <div className="px-2 pb-2">
                                <h3 className="text-lg font-bold text-slate-900 mb-1 group-hover:text-primary transition-colors">Vanilla Bean</h3>
                                <div className="flex items-center gap-1 mb-3">
                                    <span className="material-symbols-outlined text-yellow-400 text-[16px]">star</span>
                                    <span className="material-symbols-outlined text-yellow-400 text-[16px]">star</span>
                                    <span className="material-symbols-outlined text-yellow-400 text-[16px]">star</span>
                                ...
                                <div className="flex items-end justify-between mb-4">
                                    <div className="flex flex-col">
                                        ...
                                        <span className="text-2xl font-bold text-primary">$12.00</span>
                                    </div>
                                </div>
                                <button className="w-full h-12 rounded-xl bg-slate-900 text-white font-bold hover:bg-primary hover:text-slate-900 transition-all flex items-center justify-center gap-2 group/btn">
                                    <span>Add to Cart</span>
                        ...
                        <div className="group bg-white rounded-[2rem] p-3 shadow-sm hover:shadow-xl hover:shadow-primary/10 transition-all duration-300 hover:-translate-y-1 border border-transparent hover:border-primary/20">
                            ...
                            <div className="px-2 pb-2">
                                <h3 className="text-lg font-bold text-slate-900 mb-1 group-hover:text-primary transition-colors">Midnight Musk</h3>
                                <div className="flex items-center gap-1 mb-3">
                                    <span className="material-symbols-outlined text-yellow-400 text-[16px]">star</span>
                                    <span className="material-symbols-outlined text-yellow-400 text-[16px]">star</span>
                                    <span className="material-symbols-outlined text-yellow-400 text-[16px]">star</span>
                    ...
                    <div className="flex justify-center mt-12 gap-4">
                        <button className="size-12 rounded-full border border-gray-200 flex items-center justify-center hover:bg-primary hover:border-primary hover:text-slate-900 transition-all">
