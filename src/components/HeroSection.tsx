...
const HeroSection: React.FC = () => {
    return (
        <section className="w-full max-w-[1440px] px-5 md:px-10 py-8 md:py-16 bg-[#f8f7f5] dark:bg-[#1a2533]">
                ...
                <div className="flex flex-col-reverse lg:flex-row gap-10 lg:gap-20 items-center">
                    ...
                    <div
                        ...
                        <div className="flex flex-col gap-4">
                            <h1
                                className="text-[#333333] dark:text-[#E0E0E0] text-4xl md:text-6xl lg:text-7xl font-display font-black leading-[1.1] tracking-tight">
                                Upgrade Your <br /><span className="text-[#ff9900]">Daily Drive.</span>
                            </h1>
                            <h2
                                className="text-[#333333] dark:text-[#E0E0E0] text-lg md:text-xl font-normal leading-relaxed max-w-lg mx-auto lg:mx-0">
                        ...
                        <div className="flex flex-col sm:flex-row gap-4 w-full sm:w-auto">
                            <button
                                className="h-12 px-8 rounded-full bg-[#232F3E] hover:bg-[#ff9900] text-white dark:text-[#E0E0E0] text-base font-bold transition-all transform hover:scale-105">
                                Shop New Arrivals
                            </button>
                            <button
                                className="h-12 px-8 rounded-full bg-gray-100 dark:bg-gray-800 border border-gray-300 dark:border-gray-600 text-[#333333] dark:text-[#E0E0E0] hover:bg-gray-200 dark:hover:bg-gray-700 text-base font-bold transition-colors flex items-center justify-center gap-2">
                        ...
                        <div className="flex items-center gap-6 mt-2">
                            <div className="flex -space-x-3">
                                <img alt="Customer avatar"
                                    className="size-8 rounded-full border-2 border-gray-300 dark:border-gray-600 bg-gray-500"
                                ...
                                <div
                                    className="size-8 rounded-full border-2 border-gray-300 dark:border-gray-600 bg-gray-100 dark:bg-gray-800 flex items-center justify-center text-[10px] font-bold text-[#333333] dark:text-[#E0E0E0]">
                                    4k+</div>
                            </div>
                            <div className="flex flex-col">
                                ...
                                <span className="text-[#333333] dark:text-[#E0E0E0] text-xs">Trusted by 4,000+ customers</span>
                            </div>
                        </div>
                    </div>
                    {/* Image Content */}
                    <div className="flex-1 w-full lg:h-auto relative">
                        <div
                            ...
                            <div
                                className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[80%] h-[80%] bg-[#ff9900]/20 blur-[100px] rounded-full">
                            </div>
                            {/* Main Hero Image */}
                            <div
                                className="relative h-full w-full rounded-[2.5rem] overflow-hidden border border-gray-300 dark:border-gray-600 shadow-2xl bg-gray-100 dark:bg-gray-800 group">
                                ...
                                <div
                                    className="absolute bottom-6 left-6 right-6 p-4 rounded-xl bg-white/80 dark:bg-gray-900/80 backdrop-blur-md border border-gray-300 dark:border-gray-600 flex items-center justify-between">
                                    <div className="flex flex-col">
                                        <span className="text-[#333333] dark:text-[#E0E0E0] font-bold text-sm">Series 7 Smartwatch</span>
                                        <span className="text-[#ff9900] text-xs font-bold">$399.00</span>
                                    </div>
                                    <button
                                        className="size-8 rounded-full bg-[#232F3E] text-white flex items-center justify-center hover:bg-[#ff9900] transition-colors">
