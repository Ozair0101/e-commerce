                ...
                {sortedProducts.length > 0 ? (
                  sortedProducts.map((product) => (
                    <tr key={product.id} className="hover:bg-gray-50">
                      <td className="py-3 px-4 sm:py-4 sm:px-6">
                        <div className="flex items-center gap-3 sm:gap-4">
                          ...
                          <div>
                            ...
                            <div className="text-xs text-gray-500 sm:hidden">{product.id}</div>
                            <div className="text-xs text-gray-500 sm:hidden mt-1">
                              <span className="sm:hidden">{product.category}</span>
                              <span className="sm:hidden block mt-1">
                                <span className={`px-2 py-0.5 rounded-full text-xs font-medium ${getStatusClass(product.status)}`}>
                                  {product.status}
                                </span>
                              </span>
                            </div>
                      ...
                      <td className="py-3 px-4 sm:py-4 sm:px-6 text-gray-900 hidden md:table-cell">{product.category}</td>
                      <td className="py-3 px-4 sm:py-4 sm:px-6 font-medium">${product.price.toFixed(2)}</td>
                      <td className="py-3 px-4 sm:py-4 sm:px-6 text-gray-900">{product.stock}</td>
                      <td className="py-3 px-4 sm:py-4 sm:px-6 hidden sm:table-cell">
                        <span className={`px-2 py-1 sm:px-3 sm:py-1 rounded-full text-xs font-medium ${getStatusClass(product.status)}`}>
                          {product.status}
                        </span>
                      </td>
